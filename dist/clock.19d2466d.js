...
function getClock() {
  ...
  if (Number(hours) < 13) {
    ...
    var hour12 = String(hours).padStart(2, "0");
    clock.innerText = "".concat(hour12, ":").concat(minutes, ":").concat(seconds);
  }
}
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/clock.js"], null)
